...
class CF2 extends StatefulWidget {
  const CF2({Key? key}) : super(key: key);

  @override
  State<CF2> createState() => _CyclesFeedbackState();
}

class _CyclesFeedbackState extends State<CF2> {
  ...
  Future<void> _loadFeedbackData() async {
    try {
      ...
      String data = await rootBundle.loadString('assets/txt/f2.txt');
